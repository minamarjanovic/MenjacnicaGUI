		...
		if (btnDodaj == null) {
			...
			btnDodaj.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					String tekst = "Sifra: " + textFieldSifra.getText() + " Naziv: "+textFieldNaziv.getText()+" Prodajni kurs: "+textFieldProdajniKurs.getText() + " Kupovni kurs: "+textFieldKupovniKurs.getText()+ " Srednji kurs: "+textFieldSrednjiKurs.getText() + " Skraceni naziv: "+textFieldSkraceniNaziv.getText()+"\n";
				}
			});
